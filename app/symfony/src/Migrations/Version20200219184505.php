 ...
 */
final class Version20200219184505 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card_shop (card_id INT NOT NULL, shop_id INT NOT NULL, INDEX IDX_40594E004ACC9A20 (card_id), INDEX IDX_40594E004D16C4DD (shop_id), PRIMARY KEY(card_id, shop_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
