...
class SecurityCustomAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    use TargetPathTrait;
    ...
    /**
     * SecurityCustomAuthenticator constructor.
